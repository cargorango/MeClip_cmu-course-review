...
export default function HomeContent({
  ...
  return (
    <>
      {/* Real-time search bar — redirects to /courses with debounce */}
      ...
      <div className="rounded-2xl border border-purple-200 bg-gradient-to-br from-purple-50 to-indigo-50 p-6 text-center space-y-4">
        ...
        <div className="flex items-center justify-center gap-4">
          {/* Instagram */}
          <a
            href="https://www.instagram.com/meclips_official/"
            target="_blank"
          ...
          {/* X (Twitter) */}
          <a
            href="https://x.com/Meclipthailand"
            target="_blank"
            rel="noopener noreferrer"
          ...
          {/* Facebook */}
          <a
            href="https://www.facebook.com/profile.php?id=61574323546875"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Facebook"
        ...
        <p className="text-sm text-gray-600 leading-relaxed">
          รวบรวมรีวิวมากกว่า 10,000 รายวิชา จากทุกคณะใน มช.<br />
          ให้คุณเลือกอ่านเพื่อเตรียมตัว และร่วมแบ่งปันประสบการณ์ผ่านการรีวิวได้ที่นี่
        </p>
      </div>
    </>
  )
